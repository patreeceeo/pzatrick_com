...
<html lang="en">
  <head>
    ...
    <link href="${request.static_url('pzatrick_com:static/css/sontek.css')}" rel="stylesheet">
      ...
      <div class="container-fluid">
        ...
        <div class="row-fluid">
          ...
          <div class="span2">
            ...
            <ul class="categories">
              <li><a href="http://twitter.com/pzatrick">Twitter</a></li>
              <li><a href="http://github.com/pzatrick">Github</a></li>
              <li><a href="http://linkedin.com/in/pzatrick">LinkedIn</a></li>
